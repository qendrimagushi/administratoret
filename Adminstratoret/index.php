			...
			<div id="page-wrapper">
				...
				<!-- Wrapper -->
						...
						<!-- Four -->
							...
							<div class="inner">
							<h2 class="major">Login Forma</h2>
							<p style="text-align: justify;">Ju lutemi kycuni ne platform. Nese nuk jeni regjistruar ne platform ju duhet te regjistroheni. Per tu regjistruar ne platform ju duhet klikoni ne buttonin "Regjistrohuni" dhe tei jepni te dhenat e juaja.</p>
							<form method="post" action="#" style="margin-left:25% ;">
								...
								<ul class="actions">
									<li><input type="submit" class="button primary" value="Kycu" /></li>
								</ul>
