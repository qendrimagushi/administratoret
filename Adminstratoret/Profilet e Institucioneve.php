                            ...
                            <h3 class="major">Table</h3>
										...
										<div class="table-wrapper" style="overflow-x:auto; width: 100%;">
											<table style="width: 100%; white-space: nowrap; ">
												...
												<tbody>
													<tr>
														<td>Item Oneaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</td>
														<td>Ante turpis integer aliquet porttitor.</td>
														<td>29.99</td>
                                                        <td>Item One</td>
														<td>Ante turpis integer aliquet porttitor.</td>
                                                        <td><a href="modifikoPerdorues.php"  class="button primary">Modifiko</a> </td>
														<td><a href="modifikoPerdorues.php" class="button primary">Fshi</a></td>
													</tr>
												</tbody>
											</table>
										</div>
